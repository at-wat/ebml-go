...
var table = elementTable{
	...
	ElementTags:                   elementDef{[]byte{0x12, 0x54, 0xC3, 0x67}, TypeMaster, true},
	...
	ElementCodecName:              elementDef{[]byte{0x25, 0x86, 0x88}, TypeString, false},
	...
	ElementTagBinary:              elementDef{[]byte{0x44, 0x85}, TypeBinary, false},
	ElementTagString:              elementDef{[]byte{0x44, 0x87}, TypeString, false},
	ElementDateUTC:                elementDef{[]byte{0x44, 0x61}, TypeDate, false},
	ElementDuration:               elementDef{[]byte{0x44, 0x89}, TypeFloat, false},
	ElementTagName:                elementDef{[]byte{0x45, 0xA3}, TypeString, false},
	...
	ElementSimpleTag:              elementDef{[]byte{0x67, 0xC8}, TypeMaster, false},
	ElementTag:                    elementDef{[]byte{0x73, 0x73}, TypeMaster, false},
	ElementSegmentFilename:        elementDef{[]byte{0x73, 0x84}, TypeString, false},
	ElementSegmentUID:             elementDef{[]byte{0x73, 0xA4}, TypeBinary, false},
	ElementTrackUID:               elementDef{[]byte{0x73, 0xC5}, TypeUInt, false},
	ElementTitle:                  elementDef{[]byte{0x7B, 0xA9}, TypeString, false},
	...
	ElementPosition:               elementDef{[]byte{0xA7}, TypeUInt, false},

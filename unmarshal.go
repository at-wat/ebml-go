...
// ErrInvalidElementSize means that an element has an inconsistent size. e.g., element size is larger than its parent element size, invalid scalar size, or unknown size of a non-master element.
